...
def prepare_data(targets: pd.DataFrame, 
                 features_observed: pd.DataFrame, 
                 features_estimated: pd.DataFrame, 
                 features_test: pd.DataFrame) -> Tuple[pd.DataFrame, pd.DataFrame, pd.DataFrame, pd.DataFrame, pd.DataFrame, pd.DataFrame, pd.DataFrame]:
    """
    ...
    features_observed['date_forecast'] = pd.to_datetime(features_observed['date_forecast'])
    features_estimated['date_forecast'] = pd.to_datetime(features_estimated['date_forecast'])
